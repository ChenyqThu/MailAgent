...
| [`frontend/ANIMATION-GSAP-HANDOFF.md`](../../frontend/ANIMATION-GSAP-HANDOFF.md) + [`frontend/docs/motion-gsap.md`](../../frontend/docs/motion-gsap.md) | 现有动效语言（GSAP §8）：缓动 / 时长 / 入场 / prefers-reduced-motion |
| [`frontend/ARCHITECTURE.md`](../../frontend/ARCHITECTURE.md) | 渲染层架构 + §7 列表/正文/动效性能铁律（设计不能违反的运行时约束） |
| [`frontend/MOTION-PERF-HANDOFF.md`](../../frontend/MOTION-PERF-HANDOFF.md) | 动效性能 handoff |
