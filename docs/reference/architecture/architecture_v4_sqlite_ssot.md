...
> **Phase 交接**: 见 [`docs/phase1-handoff-to-phase2.md`](../../archive/2026-05/phase1-handoff-to-phase2.md)
...
**中文搜索限制**：SQLite 默认 unicode61 把连续 CJK 当**一个**大 token（不拆字），精确搜 "产品" 命不中 token "本周产品评审"。必须用前缀通配 `产品*`。生产邮件因含 markdown 标记（`*` / `[` / 空格）会自动切出独立中文 token，多数情况能直接搜中文。未来 jieba / signal-fts5-tokenizer 升级见 [`docs/phase3-complete.md`](../../archive/2026-05/phase3-complete.md) §2.3。
...
- 详见 [`docs/phase4-complete.md`](../../archive/2026-05/phase4-complete.md)
...
见 [`docs/phase1-handoff-to-phase2.md`](../../archive/2026-05/phase1-handoff-to-phase2.md)：
