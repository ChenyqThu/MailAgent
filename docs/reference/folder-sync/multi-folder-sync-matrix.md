...
> 配套：[PRD](./multi-folder-sync-prd.md) · [技术设计](./multi-folder-sync-design.md) · [设计 handoff](../../archive/2026-06/multi-folder-sync-design-handoff.md) · [mockup](../../mockups/multi-folder-sync/index.html) · [实现 handoff](../../archive/2026-06/multi-folder-sync-handoff.md)
