...
| **P4** | 换引擎：assistant-ui + AI SDK Gateway，**每 phase 跑通 eval baseline 不回退** | [`../chat-panel-ai-sdk-assistant-ui-refactor/`](../chat-panel-ai-sdk-assistant-ui-refactor/) | ◐ **Phase 00 spike ✅ GO** + **Phase 01 assistant-ui Shell ✅**（2026-06-23，`b82ee24e`，flag-off，eval 85≥baseline，reviewer APPROVE）；**Phase 02 AI SDK Gateway 待开工** |
...
| [`goal-prompts.md`](./goal-prompts.md) | **P1-P4 可粘贴 `/goal` session 启动手册**（下一 session 从这里取 **P4-Phase02 AI SDK Gateway**） |
