...
> status: in_progress（P0 止血 + P1 eval 固化 ✅ 随 v0.14.0 发布；P2/P3/P4 待开工）
...
| **P2** | 内核：memory provenance/冲突 + skill 透明 + cross-domain（**view-agnostic**） | `.trellis/tasks/06-22-harness-agent-polish/roadmap.md` Phase 3/4 | ⬜ 待开工 |
