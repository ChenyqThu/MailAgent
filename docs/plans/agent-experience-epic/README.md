...
| [`goal-prompts.md`](./goal-prompts.md) | **P1-P4 可粘贴 `/goal` session 启动手册**（下一 session 从这里取 **P4-Phase05 AG-UI interop mirror**；04b ✅ 已折叠） |
