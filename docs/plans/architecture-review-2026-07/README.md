...
| **Later（3-6 月）** | E4 可靠性/观测 **✅ 第一+第二批已落地**（第一批 2026-07-11：§1 supervise+§2 to_thread+§3 告警，`26b79707`/`6a3cc8d0`；第二批同日：§4.1 日志滚动 5 份+§4.2 诊断包导出+§5 venv 瘦身 426M→344M+§6.2/6.3 types/chat_db 巨石拆分+§6.4 注记，`046a838c`/`6d4dbca5`/`170b8777`/`c1b62d9d`/`69fdb5a2`；**仅剩 §6.1 typed IPC（独立 batch）+ §4.3 健康页（可选）+ §5b（挂起）**） | worker supervise / to_thread / 告警落地 / 诊断包 / venv 审计 / typed IPC / 巨石拆分 | 按条目 | [e4](./e4-reliability-observability.md) 顶部「落地状态」 |
