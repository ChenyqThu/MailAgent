...
> status: 进行中 —— Phase 00 spike ✅ GO（`bc5c1e80`）+ **Phase 01 assistant-ui Shell ✅**（2026-06-23，`b82ee24e`，flag-off，[phase-01 §9](./phase-01-assistant-ui-shell.md)）+ **Phase 02 AI SDK Gateway ✅**（2026-06-24，`a6d189ac`，flag-off，[phase-02 §13](./phase-02-ai-sdk-gateway.md#13-实现落地2026-06-24)）；**Phase 03a read tools 待开工**（goal-prompts P4-Phase03a）
...
| [`phase-03-tool-registry.md`](./phase-03-tool-registry.md) | 迁移工具定义前 | AI SDK tools、Python domain tool bridge、审计表兼容 — **← 下一步 03a read tools（goal-prompts P4-Phase03a）** |
