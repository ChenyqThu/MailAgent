...
| [`phase-03-tool-registry.md`](./phase-03-tool-registry.md) | 迁移工具定义前 | AI SDK tools、Python domain tool bridge、审计表兼容 — **03a read tools ✅ done（§12 落地）；← 下一步 03b write tools（goal-prompts P4-Phase03b）** |
