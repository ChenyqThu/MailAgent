...
> status: 进行中 —— Phase 00 spike ✅ GO（`bc5c1e80`）+ **Phase 01 assistant-ui Shell ✅**（2026-06-23，`b82ee24e`，flag-off，[phase-01 §9](./phase-01-assistant-ui-shell.md)）+ **Phase 02 AI SDK Gateway ✅**（2026-06-24，`a6d189ac`，flag-off，[phase-02 §13](./phase-02-ai-sdk-gateway.md#13-实现落地2026-06-24)）+ **Phase 03a read tools ✅**（2026-06-24，flag-off，[phase-03 §12](./phase-03-tool-registry.md#12-实现落地03a2026-06-24)）+ **Phase 03b write tools + HITL approval ✅**（2026-06-24，`ae268c67`，flag-off，[phase-03 §13](./phase-03-tool-registry.md#13-实现落地03b2026-06-24)）+ **Phase 04a A2UI 富工具卡片 + edit→re-approve ✅**（2026-06-24，`09424fd4`，flag-off `MAILAGENT_A2UI_TOOL_CARDS`，[architecture §13.11](./architecture.md#1311-phase-04a-落地2026-06-24a2ui-componentregistry--富工具卡片--editre-approve)）+ **Phase 04b 高风险外发 email_prepare_send + SendApprovalCard + 双 guard ✅**（2026-06-25，`66d1b489`，flag-off `MAILAGENT_AI_SDK_SEND_TOOL`，[architecture §13.12](./architecture.md#1312-phase-04b-落地2026-06-25高风险外发-email_prepare_send--sendapprovalcard--双-guard)）；**Phase 05 AG-UI interop mirror 待开工**（goal-prompts P4-Phase05；🔴 cutover 真前置 = standing-context 注入 + 会话重载，AI SDK 路径当前 context-light，AG-UI 旁路不解锁切流）
...
| [`phase-02-ai-sdk-gateway.md`](./phase-02-ai-sdk-gateway.md) | 引入 Node AI Gateway 前 | AI SDK Gateway、模型调用、UIMessage stream、持久化 — **✅ done（2026-06-24，`a6d189ac`，§13 落地）** |
| [`phase-03-tool-registry.md`](./phase-03-tool-registry.md) | 迁移工具定义前 | AI SDK tools、Python domain tool bridge、审计表兼容 — **03a read tools ✅（§12）+ 03b write tools + HITL approval ✅（§13，`ae268c67`）done** |
| [`phase-04-generative-ui-hitl.md`](./phase-04-generative-ui-hitl.md) | 上线复杂交互卡片前 | A2UI 卡片、approval、外发邮件安全底线 — **← 下一步 04a A2UI ComponentRegistry + 富卡片 + edit→re-sign（goal-prompts P4-Phase04a）** |
