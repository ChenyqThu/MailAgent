> ⚠️ **已归档存史（2026-01）**：本文是 v3 之前的过渡架构设计，已被 **v3 SQLite-First / Sprint15 SSoT inversion / Sprint16 Dual-Backend / v4 SQLite-SSoT** 全面取代。当前架构见 `ARCHITECTURE.md` 与 `docs/reference/architecture/`。
