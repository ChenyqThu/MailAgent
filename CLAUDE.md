...
## Calendar Module (2026-05-23 Phase 0+1+2+3+1.5 已上线)

**SSoT**: SQLite `calendar_event` 表 (DB v15). DavMail CalDAV → SQLite → 前端日历视图 / CLI / Notion mirror 单一数据源.

详尽 PRD: [`docs/calendar-module-prd.md`](./docs/calendar-module-prd.md)
下次 session handoff: [`docs/calendar-next-session-handoff.md`](./docs/calendar-next-session-handoff.md)
