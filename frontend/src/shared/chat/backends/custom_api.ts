...
/** P2e — the stable system identity now lives in prompts/custom_ai/soul.md
 *  (embedded byte-identically as SOUL_MARKDOWN; drift-guarded by soul.test.ts).
 *  Returned verbatim so the cacheable system prefix is unchanged (zero regression). */
