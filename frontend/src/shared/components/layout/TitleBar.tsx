...
export function TitleBar(): React.ReactElement {
  ...
  return (
    <header
      className={cn(
        // 主题 v2 — 标题栏走 .glass-bar tier (主题 v3/C2: specular 镜面高光已退役)
        'h-titlebar shrink-0 glass-bar border-b border-ink-border/60',
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex justify-center">
        <button
          ...
          className={cn(
            'group flex items-center gap-2 px-3 py-1 rounded-[var(--r-ctl)] text-aux text-ink-fg-2',
