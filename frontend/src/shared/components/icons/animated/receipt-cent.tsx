// lucide-animated · receipt-cent。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function ReceiptCentIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      <motion.path d="M12 7v10" variants={CENT_SECONDARY_VARIANTS} />
      <motion.path
