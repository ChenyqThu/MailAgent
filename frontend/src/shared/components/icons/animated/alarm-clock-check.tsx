// lucide-animated · alarm-clock-check。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function AlarmClockCheckIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props} svgStyle={{ overflow: 'visible' }}>
      ...
      <motion.path d="m9 13 2 2 4-4" variants={PATH_VARIANTS} />
    </IconShell>
  )
}
