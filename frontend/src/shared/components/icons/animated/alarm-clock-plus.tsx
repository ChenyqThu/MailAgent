// lucide-animated · alarm-clock-plus。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function AlarmClockPlusIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props} svgStyle={{ overflow: 'visible' }}>
      ...
      <motion.path d="M12 10v6" variants={PATH_VARIANTS} />
    </IconShell>
  )
}
