// lucide-animated · square-arrow-right。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function SquareArrowRightIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      <motion.rect height="18" rx="2" variants={SQUARE_VARIANTS} width="18" x="3" y="3" />
      <motion.path d="M8 12h8" variants={PATH_VARIANTS} />
      <motion.path d="m12 8 4 4-4 4" variants={SECOND_PATH_VARIANTS} />
    </IconShell>
  )
}
