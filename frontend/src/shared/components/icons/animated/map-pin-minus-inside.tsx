// lucide-animated · map-pin-minus-inside。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function MapPinMinusInsideIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props} svgVariants={SVG_VARIANTS}>
      <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0" />
      <motion.path d="M9 10h6" variants={MINUS_VARIANTS} />
    </IconShell>
  )
}
