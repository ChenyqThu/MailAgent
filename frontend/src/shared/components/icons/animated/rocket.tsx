// lucide-animated · rocket（火箭飘移 + 尾焰闪动）。源 pqoqubbw/icons，改造：spring→tween + ICON_EASE（§10）；去 forwardRef/div 外壳；svg 整体漂移 + motion.path 尾焰变形。
...
export function RocketIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell
      {...props}
