// lucide-animated · message-square-check。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function MessageSquareCheckIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
