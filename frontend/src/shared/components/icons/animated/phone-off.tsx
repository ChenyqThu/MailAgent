// lucide-animated · phone-off。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function PhoneOffIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      ...
      <motion.path d="M22 2 2 22" variants={PATH_VARIANTS} />
