// lucide-animated · git-pull-request-create。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function GitPullRequestCreateIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      <motion.circle
        cx="6"
