// lucide-animated · corner-right-down。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function CornerRightDownIcon(props: AnimatedIconProps): React.ReactElement {
  return (
