// lucide-animated · battery-full。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function BatteryFullIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      ...
      <motion.line custom={2} variants={LINE_VARIANTS} x1="14" x2="14" y1="11" y2="13" />
    </IconShell>
  )
}
