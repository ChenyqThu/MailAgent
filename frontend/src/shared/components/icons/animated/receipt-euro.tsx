// lucide-animated · receipt-euro。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function ReceiptEuroIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      <motion.path
      ...
      <motion.path d="M8 12h5" variants={EURO_SECONDARY_VARIANTS} />
    </IconShell>
  )
}
