// lucide-animated · euro。源 pqoqubbw/icons（MIT，见 ./LICENSE-pqoqubbw）。
...
export function EuroIcon(props: AnimatedIconProps): React.ReactElement {
  return (
    <IconShell {...props}>
      <motion.path
      ...
      />
      <motion.path d="M16 10h-12" variants={EURO_SECONDARY_VARIANTS} />
      <motion.path d="M13 14h-9" variants={EURO_SECONDARY_VARIANTS} />
    </IconShell>
  )
}
