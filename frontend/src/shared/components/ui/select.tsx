...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-meta font-mono uppercase tracking-wider text-ink-fg-2',
      className
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'py-1.5 pl-7 pr-2 text-aux text-ink-fg outline-none',
      'focus:bg-ink-3 focus:text-ink-fg',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn('-mx-1 my-1 h-px bg-ink-border-soft', className)}
    {...props}
  />
))
