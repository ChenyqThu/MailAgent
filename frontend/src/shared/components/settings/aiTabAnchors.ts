...
export const AI_TAB_ANCHOR_IDS = {
  ...
  imageGenModel: 'settings-ai-image-gen-model',
  cache: 'settings-ai-cache',
  autoTitle: 'settings-ai-auto-title',
  autoCompact: 'settings-ai-auto-compact',
...
export function useAiTabAnchorItems(): SectionAnchorItem[] {
  ...
  return React.useMemo(
    () => [
      ...
      { id: AI_TAB_ANCHOR_IDS.imageGenModel, label: t('settings.imageGenModel.title') },
      ...
      { id: AI_TAB_ANCHOR_IDS.autoCompact, label: t('settings.ai.autoCompact.title') },
