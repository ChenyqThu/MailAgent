...
//
// P1-4 A-1 split (2026-07-10) — this file is now the stateful container
// (data pipeline: 5 useQuery → filter/group/paginate → rows/rowHeights,
// scroll anchoring, snippet lazy-fetch, list JSX). The extracted seams:
