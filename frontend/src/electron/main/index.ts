...
// 已装用户兜底 #2: .env 存在但缺 MAILAGENT_OUTBOX_ENABLED (老 onboarding 没写) →
// 补默认 'true', 否则 FanoutWorker 永不跑, 旗标/已读/完成只改本地永不同步到
// Exchange/Notion (实测积压 1564 条)。显式 false 不覆盖。见 lib/outbox-default。
