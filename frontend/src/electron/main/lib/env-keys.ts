...
export const MANAGED_ENV_KEYS = [
  ...
  // 事项（Matters MVP）：Python pydantic（serve-api 的 /api/matters + /chat/config 投影、
  // serve 的 MatterAgendaWorker）+ Electron main（gateway matter 工具、原生通知）双载体。
  // 后端重启让导航与 REST 生效；AI 工具与通知要退出重开 App。
