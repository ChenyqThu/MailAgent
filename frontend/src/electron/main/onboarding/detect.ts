...
//
// 必填键口径与后端 config.py 的 Field(...) 强制项对齐:
//   NOTION_TOKEN / EMAIL_DATABASE_ID / USER_EMAIL。
...
export const ONBOARDING_REQUIRED_KEYS = ['NOTION_TOKEN', 'EMAIL_DATABASE_ID', 'USER_EMAIL'] as const
