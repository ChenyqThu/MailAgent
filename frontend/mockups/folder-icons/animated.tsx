...
// 读的，不是手打）。⚠️ 主仓已有的三个（folder-input / folder-plus / folders）
// 是更早版本的 lucide 几何，与 1.16.0 的 d 串**对不上**；本文件统一按 1.16.0
// 重写，保证 24 个同版本。移植回主仓时要决定：是把那三个也刷成新几何（推荐，
// 一致），还是保留旧的（那 24 格里会有三个形状略微不同）。
//
// ── 移植 ──────────────────────────────────────────────────────────────────
